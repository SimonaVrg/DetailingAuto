	...
	include "functions2.php";
		...
		echo '<div class="gestPretServ">';
			...
			echo'<div class="vizPretServ">';   // inc div vizPretServ
				...
				$sql2 = "SELECT DISTINCT codVoucher, startDate, endDate FROM coduripromo ";//ORDER BY numeAng ASC";
						...
						$color="lighterColor";
							while($row = $result->fetch_assoc()) {
								...
								$endDate=$row["endDate"];
									...
									/*
									echo 'Data inceput: '.$startDate.' <br>';
									echo 'Data sfarsit: '.$endDate.' <br>';
									*/
									
									echo 'Validitate: '.$startDate.' - '.$endDate.' <br>';
									echo 'Folosit: '; count_cod_withDates($codVoucher,'folosit'); 
									echo 'Disponibil: '; count_cod_withDates($codVoucher,'disponibil');
